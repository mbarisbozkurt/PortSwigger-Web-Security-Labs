...
![TrackingId cookie değeri üzerinde UNION SELECT NULL payload'ı test ediliyor](images/lab13/1.png)
...
![information_schema sorgusunda SQL hata mesajı response içinde görüntüleniyor](images/lab13/2.png)
...
![Alt sorgu birden fazla satır döndürdüğü için hata alınıyor](images/lab13/3.png)
...
![CAST hatası içinde administrator kullanıcı adı görüntüleniyor](images/lab13/4.png)
...
![CAST hatası içinde administrator parolası görüntüleniyor](images/lab13/5.png)

6. Elde ettiğim parola ile `administrator` hesabına giriş yaptım ve labı tamamladım.

![administrator hesabıyla giriş yapıldı ve lab tamamlandı](images/lab13/6.png)
