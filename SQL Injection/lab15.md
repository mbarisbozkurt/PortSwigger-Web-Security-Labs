...
![Doğru koşulda pg_sleep(10) çalıştırılarak response süresi geciktiriliyor](images/lab15_1.png)
...
![Yanlış koşulda pg_sleep(10) çalışmadığı için response gecikmeden dönüyor](images/lab15_2.png)
...
![administrator parolasının uzunluğu LENGTH fonksiyonu ile 20 olarak doğrulanıyor](images/lab15_3.png)
...
![SUBSTRING ile administrator parolasının belirli karakteri zaman gecikmesine göre test ediliyor](images/lab15_4.png)
...
![Burp Intruder üzerinde karakter pozisyonu payload olarak işaretleniyor](images/lab15_5.png)
...
![Intruder sonuçlarında yüksek response süresi doğru karakteri gösteriyor](images/lab15_6.png)
...
![administrator hesabıyla giriş yapıldı ve lab tamamlandı](images/lab15_7.png)
