...
![Doğru koşulda SQL hatası tetiklenerek 500 Internal Server Error alınıyor](images/lab12/1.png)
...
![Yanlış koşulda hata tetiklenmediği için 200 OK response dönüyor](images/lab12/2.png)
...
![administrator parolasının uzunluğu LENGTH fonksiyonu ile 20 olarak doğrulanıyor](images/lab12/3.png)
...
![Burp Intruder sonuçlarında 500 dönen isteklerle doğru karakterler belirleniyor](images/lab12/4.png)
...
![administrator hesabıyla giriş yapıldı ve lab tamamlandı](images/lab12/5.png)
